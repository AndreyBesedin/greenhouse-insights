...
upstream provider (docs/design/wur_real_data_ingestion_replay_plan.md
section 4.2). Every path verifies the manifest's checksum, and a caller
...
from ingestion.manifests import ArtifactManifest, DatasetManifest
